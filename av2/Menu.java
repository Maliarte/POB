...
public class Menu {
    ...
    public void Processamento() {
        ...
        do {
            ...
            int qtdCamas = Integer.parseInt(sc.nextLine());

            System.out.println("Informe o tipo de cama: \n1- Beliche\n2- Solteiro");
            int tipoCama = Integer.parseInt(sc.nextLine());

            // Calcular quantidade de diárias e valor total da reserva
